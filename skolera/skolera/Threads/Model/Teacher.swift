...
class Teacher : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        actableId = dictionary["user_id"] as? Int
    ...
    {
        actableId = aDecoder.decodeObject(forKey: "user_id") as? Int
    ...
    {
        if actableId != nil{
            aCoder.encode(actableId, forKey: "user_id")
        }
        if avatarUrl != nil{
