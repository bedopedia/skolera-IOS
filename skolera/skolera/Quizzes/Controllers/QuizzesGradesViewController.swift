            ...
            if isSuccess {
                if feedback.isEmpty {
                    ...
                    if feedbackId == -1 {
                        ...
                        self.updateFeedback(submissionId: self.quiz.id!, studentId: submission.studentId, feedback: feedback, feedbackId: feedbackId)
                    }
...
//        updatefeedbackApi(feedbackId: feedbackId, parameters: parameters)
    }
}
